"""
    ...
    Copyright (C) 2023  Cyber Darker (github.com/CyberDarker
)
    ...
    original developer, [Mohd Azeem (github.com/CyberDarker
)], and copying the code
    is not permitted without permission.

    For any queries, Contact me at : cyberdarker7878@gmail.com
"""
...
banner2 = f"""
        ...
        ░█─── ▀──▀ ▀▀▀▀ ▀──▀ ▀▀▀ ░█▄▄▄█ █▀▀▀ ▀▀▀ ▀▀▀▀ ▀▀▀ ──▀── 　 ░█─── ▀─▀▀ ▀▀▀▀
            ...
            {color.RED}{version}{color.WHITE}            {color.WHITE}By github.com/CyberDarker
"""
...
"""
"""
Copyright © 2023 CyberDarker (github.com/CyberDarker)
"""
