...
![GitHub release (latest by date)](https://img.shields.io/github/v/release/CyberDarker/PhoneSploit-Pro)
![Python](https://img.shields.io/badge/python-v3.10%2B-blue)
![GitHub Release Date](https://img.shields.io/github/release-date/CyberDarker/PhoneSploit-Pro?logo=github)
![GitHub last commit](https://img.shields.io/github/last-commit/CyberDarker/PhoneSploit-Pro?logo=github)
![GitHub Repo stars](https://img.shields.io/github/stars/CyberDarker/PhoneSploit-Pro?style=social)
![GitHub forks](https://img.shields.io/github/forks/CyberDarker/PhoneSploit-Pro?style=social)
...
Make sure all the [required](https://github.com/CyberDarker/PhoneSploit-Pro#requirements) software are installed.

Open terminal and paste the following commands : 
```
git clone https://github.com/CyberDarker/PhoneSploit-Pro.git
```
```
cd PhoneSploit-Pro/
```
...
<a href="https://github.com/CyberDarker/">
...
**Cyber Darker** - [@CyberDarker](https://github.com/CyberDarker/)
...
Copyright © 2024 Cyber Darker (github.com/CyberDarker)
